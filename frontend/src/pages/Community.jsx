  ...
  return (
    ...
    >
      ...
      <div className="p-5 flex-1 flex flex-col">
        ...
        <button className={`w-full mt-4 py-2.5 rounded-xl font-medium text-sm transition-colors ${
  ...
  return (
    <div className="space-y-6 max-w-6xl mx-auto pb-12">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          <select 
            ...
            className="input-field py-2.5 bg-white shadow-sm"
          >
          ...
          <button 
            ...
            className="btn-primary py-2.5 flex items-center gap-2 whitespace-nowrap shadow-sm"
          >
      ...
      {isLoading && posts.length === 0 ? (
        ...
        <div className="flex flex-col items-center justify-center p-16 text-center card bg-gray-50/50 border-dashed">
